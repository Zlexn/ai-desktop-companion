...
class ConsentMutation:
    def __init__(self, fence: EmotionAnalysisDispatchFence) -> None:
        self._fence = fence
        self._entered = False
...
class EmotionAnalysisDispatchFence:
    """Serializes dispatch while giving consent mutations queue priority."""
